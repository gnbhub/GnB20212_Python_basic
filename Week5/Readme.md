...
## Quiz
입금, 출금, 잔고확인 함수를 작성하고자 한다. 미완성된 부분을 완성해주세요.
입력받는 자료형 제한은 신경쓰지 않아도 좋습니다. 가능하시다면 try-except를 활용해서 입력받는 자료형을 제한해보세요.
<br>다시한번 강조하겠습니다. String자료형과 Int자료형은 `+`로 concatenate 할 수 없습니다. int형 변수를 str()을 통해 형변환해서
붙여 쓰세요
```python
balance = 0 #잔고
